...
func accountI18nEN() accountI18n {
	return accountI18n{
		...
		QuickAmount150:         "150 RUB",
		QuickAmount300:         "300 RUB",
		QuickAmount450:         "450 RUB",
		QuickAmount600:         "600 RUB",
		TopUpCustomLabel:       "Custom amount: 50–10,000 RUB, up to 2 decimal places",
		TopUpCustomPlaceholder: "For example 250",
		TopUpForecastHint:      "Amount calculated from billing data for service payment or renewal.",
		TopUpNoForecast:        "Could not calculate the payment amount. Top up your balance manually.",
		TopUpSubmitBtn:         "Go to payment",
		TopUpCurrencyNote:      "Balance is shown in RUB. Crypto payment options may display available currencies on the payment provider page.",
